...
from endpoints.serializers.webhook import WHExpiringSerializer, WHClientCreateSerializer, WHPaymentSerializer


class WHClientCreateView(APIView):
    authentication_classes = [BasicAuthentication]
    permission_classes = [IsAuthenticated]

    @extend_schema(request=WHClientCreateSerializer())
    def post(self, request):
        serializer = WHClientCreateSerializer(data=request.data)
